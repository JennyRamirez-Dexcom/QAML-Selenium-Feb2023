...
public class BaseTest {
    ...
    public WebDriver getWebDriver(String browser) {
        switch (browser) {
            ...
            default:
                driverRootPath = new File(getproperties("EDGEDRIVER"));
    ...
    public  String getproperties(String propertyKey){
        ...
        try {
            inputStream= new FileInputStream("/Users/diana.figueroa/Desktop/QAML-Project-DemoBlaze/settings.properties");
